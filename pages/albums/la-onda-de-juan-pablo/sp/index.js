...
const ArContent = ({selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Esta canción surge después de una conversación con Dan Rubenstein en la que me pidió que escriba una canción que hable de "Las Relaciones Familiares". Dan es el director de la película Noemi Gold en la cual yo iba actuar y cantar una canción.</p>
    <img src={require('../../../../static/images/argentina-2.jpg')} style={{width: '100%'}}/>
    <p>Cuando la estaba componiendo la canción salió rápida y de manera natural. Improvisé la letra mientras escuchaba un beat repetitivo en mis auriculares.</p>
    <p>El arreglo final surgió mucho mas tarde. Estaba buscando una manera de que el tema sonara como un tema folclórico de la Cuenca del Plata.</p>
    <p>En Buenos Aires conocí a Alejandro Dominguez, tío de Juan Cruz Zaballa (Tall Juan), quien se especializa en este estilo musical.</p>
    <p>El día de la grabación viajé en tren desde Capital Federal hasta San Antonio de Padua en la provincia de Buenos Aires, donde vive Alejandro. Ahí Duilio de Buono nos prestó su estudio para instalar los equipos y asistió la grabación. Nos llevó mucho tiempo encontrar una manera de agregar este tipo de guitarras sobre la canción pero después de muchos intentos, logramos acoplarnos.</p>
...
const UrContent = ({selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>La melodía de <em>Candombe Instrumental</em> me llegó mientras caminaba con mi guitarra por Buenos Aires un par de días antes de viajar a Montevideo.</p>
    <img src={require('../../../../static/images/uruguay-1.jpg')} style={{width: '100%'}}/>
    <p>Cuando llegué a la ciudad que me vio nacer pensé en diferentes maneras para capturar esta melodía sobre un candombe. Inicialmente yo quería grabar a los tamboriles en su contexto natural, la calle. Después de muchos intentos fallidos, decidí grabar solamente tres personas en un cuarto. La grabación de los tamboriles la hicimos en el estudio de Federico Graña y eso fue lo único que me llevé de Montevideo. El resto de los instrumentos fueron grabados en NY durante el verano del 2018.</p>
    <p>Un día, después de ver a Uruguay ser eliminado de la Copa del Mundo, con lagrimas en los ojos, en un ómnibus yendo a casa, escribí un poema. En el poema me imaginé que era un niño que en su sueño se veía como un jugador de fútbol profesional. A eso lo mezclé con la idea de que un partido entre amigos y un partido en el mundial es esencialmente lo mismo, 22 personas jugando al fútbol.</p>
    <img src={require('../../../../static/images/uruguay-2.jpg')} style={{width: '100%'}}/>
    <p>Al tener el poema terminado pensé en agregárselo a <em>Candombe Instrumental</em>. Invité a mi padre para que recite el poema porque quería compartir esta canción con él y también porque es de Montevideo y supe que le daría el sentimiento indicado.</p>
    <h3>Músicos:</h3>
    <ul>
...
const ClContent = ({selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Una noche terminé en una <em>peña</em> en Santiago. Ahí vi payadores tocar y cantarse uno al otro. Me fui pensando en lo bueno que eran ellos en su música. La noche continuó y más tarde conocí a Manuela. Hablando con ella me enteré que uno de los payadores era medio-hermano de ella. Le pregunté si a él le gustaría grabar conmigo. Me dijo que lo llame y le pregunte. Lo llamé.</p>
    <img src={require('../../../../static/images/chile-1.jpg')} style={{width: '100%'}}/>
    <p>Hablamos un rato por teléfono. Su nombre era Luciano y tocaba el guitarrón chileno, cordófono tradicional de Chile que tiene veinticinco cuerdas y no se sabe de su procedencia. Le comenté a Luciano sobre el proyecto y dijo que estaría feliz de participar. Hicimos planes para juntarnos a tocar la canción. Nos juntamos en una plaza del Barrio Independencia. Tocamos la canción muchas veces buscándole el arreglo indicado para el instrumento.</p>
    <p>Unos días después hablamos y arreglamos para juntarnos y grabar la canción. Lo hicimos en su casa. Compartimos comida y jugo cuando paramos un poco entre toma y toma.</p>
    <p>Tocamos la canción muchas veces hasta que logramos tocarla naturalmente y distendidos.</p>
    <img src={require('../../../../static/images/chile-3.jpg')} style={{width: '100%'}}/>
    <p>Después de la grabación, guardé mis equipos y nos pusimos a hablar debajo de una parra en el patio de la casa.</p>
    <p>Las flautas fueron grabadas más adelante por Pedro "Piter" Davila en mi dormitorio en Tlatelolco, Ciudad de México.</p>
...
const PeContent = ({selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Conocí a Walter en la Plaza 2 de Mayo de Lima. En esa zona hay muchas tiendas de música y es donde los músicos se congregan. Durante mi estadía en la ciudad frecuentaba mucho esta plaza porque pensaba que sería un buen lugar para conocer gente con quien tocar.</p>
    <img src={require('../../../../static/images/harpa.jpg')} style={{width: '100%'}}/>
    <p>Un día caminado por las tiendas de instrumentos con mi amigo Humberto, vi a Walter con su arpa mientras hablaba con su amigo. Lo saludé y le pregunté si podía tocar un poco. Yo estaba impresionado por la presencia y el tamaño del instrumento. Walter tocó el arpa por unos 5 segundos y paró. En ese tiempo pude ver sus dedos muy estilizados acariciar las cuerda. Sonó divino. Quedé demasiado intimidado, así que solo pude agradecerle y me fui.</p>
    <p>Después de eso estuve pensando en él y su arpa. Un día junté coraje y volví para hablar con él. Le pregunté si tocaría en una grabación conmigo y dijo que sí. Después de eso tuve que pensar cuál canción quedaría bien con con el arpa. Un Buen Día Hoy Será no era del grupo de canciones que yo pensaba grabar en el viaje. Había escrito esta canción un tiempo atrás en NY como un "canto de trabajadores", una marcha laboral. Solamente tenía la melodía repetitiva y la letra pero por su forma pensé que la canción funcionaría bien con su instrumento.</p>
    <p>Walter y yo nos juntábamos todos los días para hablar y tocar la canción. Los dos juntos buscamos el arreglo en su tienda mientras él vendía arpas. La grabación la hicimos en la casa de Humberto un día antes de dejar Lima.</p>
    <h3>Músicos:</h3>
    <ul>
...
const MxContent = ({onCountryClick, selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Esta es la primer canción que escribí durante mis días en Mexico. Cuando la escucho me doy cuenta como la letra describe las primeras impresiones que tuve al llegar a la ciudad. La letra tiene dos partes: una habla de pequeños detalles mi vida diaria en la colonia donde yo habitaba (Sta. María la Ribera) y la otra parte está compuesta por tres observaciones que yo noté en su sistema de metro.</p>
    <p>Cuando llegó la hora de grabar esta canción, yo supe que debería ser en México. Primero grabé las guitarras y las voces en mi cuarto en Tlatelolco. Después invité a Izakúm para q grabe la percusión. Una vez que la canción tenía una estructura empecé a buscar a alguien que toque el saxofón. Lo busqué por días, le pregunté a toda la gente que conocía y no apareció nadie en México. Al final esto funcionó a mi favor. El próximo destino de mi viaje era San Juan, Puerto Rico y ahí fue donde conocí a Juan Botta. El vino a la casa de Moni, donde yo me estaba quedando y ahí trabajamos la idea juntos. Juan hizo un magnifico trabajo al doblar el saxofón, consiguiendo también un sonido mas grande y rico.</p>
...
const Mx2Content = ({onCountryClick, selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p><em>A Volar</em> es una de las tantas canciones que surgieron durante mi estadía en Ciudad de México. En ese lugar yo andaba fascinado y muy inspirado por la fuerza de su cultura local. Vi a su tradición reinar sobre todos los aspectos de la sociedad.</p>
    <p>La canción es un canto a mi mismo desde el "yo fantasía" que me ayuda durante momentos difíciles en mi vida. El "yo fantasía" es un alter ego creado en mi expresión que me marca el camino a seguir. En esta canción, el personaje me invita a vivir una vida aventurera y enfrentarla peleando contra las adversidades de esta vida moderna.</p>
    <img src={require('../../../../static/images/mexico-a-volar.jpg')} style={{width: '100%'}}/>
    <p>El arreglo surge después de una conversación que tuve con mi amigo David. Él vive en un pueblo en las afueras de la ciudad y nos conocimos durante mi primer visita a Mexico en 2015. A él le gustan muchos estilos musicales y muy seguido tenemos conversaciones sobre eso. Cuando le mostré el demo que había grabado para <em>A Volar</em> él pensó que sonaba como un Bolero Ranchero, un estilo del Norte de México. Después de la conversación yo me dediqué a escuchar mucho este estilo y a través de esto diseñé el arreglo para la versión final de la canción.</p>
    <p>A René y Yonathan los conocí a través de Pati, ella grabó la marimba en <em>Disfruta la Fruta</em>. Ambos trabajan en Garibaldi (plaza en Ciudad de México conocida por ser el espacio donde la gente puede contratar músicos para fiestas). Los dos vinieron a grabar a Tlatelolco donde yo tenía mis equipos. El acordeón fue grabado en el estudio de Oswaldo, que improvisó el arreglo en una toma y luego agregó una segunda línea que complementó extraordinariamente a la primera.</p>
    <h3>Músicos:</h3>
    <ul>
...
const Mx3Content = ({onCountryClick, selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Esta canción surge después de escuchar la frase "Disfruta la Fruta" y darme cuenta de lo buena que era la calidad de la fruta en Mexico. Quise que la canción sea algo como el pregón de un feriante, algo parecido a los sonidos que escuchaba en los mercados de la ciudad.</p>
    <p>Para esta canción le pedí a los músicos que improvisen sobre el tema tocando las notas de la escala en Sol mayor. Las voces que me acompañan durante el estribillo fueron grabadas por Laura y Joana en una noche de verano en NY.</p>
...
const PrContent = ({selectedPlayer, onSelectPlayer}) => (
  <div>
    ...
    <YouTube
      ...
      opts={opts}
    />
    <p>Puerto Rico fue uno de los primeros países de Latinoamérica que visité aparte de Uruguay y los países del cono sur. La gente en Puerto Rico son grandes anfitriones en su isla. Les encanta mostrar su cultura a los visitantes. Un día estaba con amigos y me llevaron a Charco Azul en Guavate. Subiendo la montaña paramos en uno de los puestos para comer lechón. Mientras esperábamos la comida escuchamos un duo tocar boleros. Desde mi niñez conocía estas canciones pero nunca había visto esa música en su contexto. En ese momento, esa música tuvo un gran impacto en mi.</p>
    <img src={require('../../../../static/images/puerto-rico-1.jpg')} style={{width: '100%'}}/>
    <p>Unos días después, en NY, se me ocurrió la melodía que ahora es el motivo principal de 'Guapa'. Pensé que estaría bueno usarla como una melodía entre estrofas en un bolero. Unos días mas tarde mientras viajaba en el tren, se me ocurrió la letra y melodía para el resto de la canción.</p>
    <img src={require('../../../../static/images/puerto-rico-2.jpg')} style={{width: '100%'}}/>
    <p>La canción inmediatamente fue recibida de manera positiva en mis conciertos. Esto me llevó a llegar a tocarla, con el acompañamiento de la gente, unas veinte o treinta veces en un mismo concierto.</p>
    <p>Cuando llegó el momento de grabar la canción yo supe que debía ser grabada en Puerto Rico. Una tarde nos juntamos en la casa de mi amiga Monica en Santurce y entre charlas, sudor, comida y trago grabamos la canción. Nos llevó un tiempo buscar el arreglo pero después de un rato le encontramos el sonido. Fue una divina experiencia.</p>
    <h3>Músicos:</h3>
    <ul>
          ...
          <IntroContent  pose={showIntro?'shown':'hidden'} className="intro-content">
            <div className="intro-content-inner">
              {showVideo ? (<div>
                ...
                <p>“La Onda de Juan Pablo” es una colección de canciones grabadas con músicos locales durante un viaje a través de Latino America.</p>
                <p>Juan armó un mapa interactivo para que acompañes su viaje, sus experiencias y el proceso creativo de este álbum. Igualmente antes de empezar, les dejamos un video con un mensaje de Juan:</p>
                <br/>
                <YouTube
                  videoId='XOTv1AQtZ4E'
                  opts={opts}
                ...
                <p>Cliquea sobre los diferentes países para aprender más sobre el viaje y escuchar la música que se grabó ahí.</p>
                <p>Mientras las canciones van saliendo, mas países del mapa se irán habilitando. Asegúrate de volver pronto para enterarte sobre las últimas novedades o suscríbete para recibir un mensaje en el momento q las canciones salgan.</p>
          ...
          <ComingSoon pose={showComingSoon?'shown':'hidden'} className="coming-soon-container" onClick={() => this.hideComingSoon()}>
            <div className="coming-soon">
              <div className="coming-soon-inner" onClick={(e) => e.stopPropagation()}>
                ...
                <p>Estas canciones serán lanzadas pronto. Subscríbete para enterarte cuando vayan saliendo.</p>
